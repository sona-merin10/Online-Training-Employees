...
Public Class Trainer
    ...
    Protected Sub btntrsub_Click(sender As Object, e As EventArgs) Handles btntrsub.Click
        Dim instr As String
        instr = "insert into Trainer_table(Training_id,Name,Address,Type)values(" + trainertraiid.SelectedValue + ",'" + trainerna.Text + "','" + traineraddress.Text + "','" + trtritype.SelectedItem.Text + "')"
