...
Public Class EmpSignin
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If AuthenticateUser(usernameOrEmail, password) Then
            ...
            ' "SELECT Designation FROM Employee_table WHERE Email = '" + txtemail.Text + "'  AND Pass = '" + txtpass.Text + "'
            Dim query1 As String = "SELECT  Designation_name FROM Designation_table INNER JOIN Employee_table ON Designation_table.Designation_id= Employee_table.Designation_id where Email = '" + txtemail.Text + "'  AND Pass = '" + txtpass.Text + "' "
            Dim com As SqlCommand = New SqlCommand(query1, co.connect())
            Dim sqlda As SqlDataAdapter = New SqlDataAdapter(com)
            Dim ds As DataTable = New DataTable
            sqlda.Fill(ds)
            If ds(0)(0) = "HR" Then
                Response.Redirect("HR page.aspx")
            End If
